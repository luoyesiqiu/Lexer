...
<YYINITIAL> {
  ...
  "asm"                         { return CType.KEYWORD; }
  "break"                        { return CType.KEYWORD; }
  "bool"                        { return CType.KEYWORD; }
  "case"                         { return CType.KEYWORD; }
  "catch"                        { return CType.KEYWORD; }
  "char"                         { return CType.KEYWORD; }
  "const"                        { return CType.KEYWORD; }
  "const_cast"                    { return CType.KEYWORD; }
  "continue"                     { return CType.KEYWORD; }
  "class"                         { return CType.KEYWORD; }
  
  "default"                      { return CType.KEYWORD; }
  "delete"                      { return CType.KEYWORD; }
  "do"                           { return CType.KEYWORD; }
  "double"                       { return CType.KEYWORD; }
  "dynamic_cast"                       { return CType.KEYWORD; }
  
  "else"                         { return CType.KEYWORD; }
  "extern"						 { return CType.KEYWORD; }
  "enum"						 { return CType.KEYWORD; }
  "explicit"					{ return CType.KEYWORD; }
  "float"                        { return CType.KEYWORD; }
  "for"                          { return CType.KEYWORD; }
  "false"                         { return CType.KEYWORD; }
  "friend"                         { return CType.KEYWORD; }
	
  "goto"                         { return CType.KEYWORD; }
  "if"                           { return CType.KEYWORD; }
  "inline"                       { return CType.KEYWORD; }
  "int"                          { return CType.KEYWORD; }
  "long"                         { return CType.KEYWORD; }
  
  "mutable"                      { return CType.KEYWORD; }
  "namespace"                    { return CType.KEYWORD; }
  "new"                      	 { return CType.KEYWORD; }
  
  "operator"                     { return CType.KEYWORD; }
  
  "private"                      { return CType.KEYWORD; }
  "protected"                      { return CType.KEYWORD; }
  "public"                      { return CType.KEYWORD; }
  
  "return"                       { return CType.KEYWORD; }
  "register"                     { return CType.KEYWORD; }
  "reinterpret_cast"              { return CType.KEYWORD; }
  "restrict"                        { return CType.KEYWORD; }
  
  "short"                        { return CType.KEYWORD; }
  "switch"                       { return CType.KEYWORD; }
  "static"                       { return CType.KEYWORD; }
  "static_cast"                   { return CType.KEYWORD; }
  "signed"                       { return CType.KEYWORD; }
  "struct"                       { return CType.KEYWORD; }
  "sizeof"                       { return CType.KEYWORD; }
  
  "template"                      { return CType.KEYWORD; }
  "this"                      { return CType.KEYWORD; }
  "throw"                      { return CType.KEYWORD; }
  "true"                      { return CType.KEYWORD; }
  "try"                      { return CType.KEYWORD; }
  "typedef"                      { return CType.KEYWORD; }
  "typeid"                      { return CType.KEYWORD; }
  "typename"                      { return CType.KEYWORD; }
	
  "unsigned"                     { return CType.KEYWORD; }
  "union"                     	 { return CType.KEYWORD; }
  "using"                     { return CType.KEYWORD; }
  "virtual"                         { return CType.KEYWORD; }
  "volatile"                         { return CType.KEYWORD; }
  "void"                         { return CType.KEYWORD; }
  "wchar_t"                        { return CType.KEYWORD; }
